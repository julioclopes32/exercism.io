...
SPECIAL_INGREDIENTS = {'cream', 'bacon', 'garlic', 'baby scallops', 'mussels', 'baby squid', 'cashews',
                       'salmon fillets',
                       'filo pastry', 'almonds', 'milk', 'blue cheese', 'clams', 'shrimp', 'tomato puree', 'chocolate',
                       'honey', 'anchovy fillets', 'bulgur', 'prawns', 'parmesan cheese', 'fish',
                       ...
                       'toasted bread', 'parmesan', 'beef', 'tofu', 'flour', 'tomatoes', 'red onion',
                       'slivered almonds',
                       'strawberries', 'onions', 'pine nuts', 'cherry tomatoes', 'soy sauce', 'oyster sauce',
                       'mozzarella cheese', 'roma tomatoes', 'heavy cream', 'paneer', 'pork tenderloin',
                       'garlic cloves',
